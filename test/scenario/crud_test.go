...
func TestWithoutReminder(t *testing.T) {
	...
	scenarios := []struct {
		...
		{
			name:      "list added tasks in the order of priority",
			command:   []string{"l"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder  Priority\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00            0\n4   scenario test 6                                                               50\n2   scenario test 1                                                               100\n3   scenario test 2                                     2099/1/1 00:00  macos     100\n",
			wantError: false,
			err:       "",
		},
		{
			name:      "list added tasks in the order of ID",
			command:   []string{"l", "-o", "id"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder  Priority\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00            0\n2   scenario test 1                                                               100\n3   scenario test 2                                     2099/1/1 00:00  macos     100\n4   scenario test 6                                                               50\n",
			wantError: false,
			err:       "",
		...
		{
			name:      "modify task 1",
			command:   []string{"m", "-t", "scenario test modified 1", "-i", "2", "-d", "2099/01/01 12:00"},
			hasOutput: false,
			want:      "",
			wantError: false,
			err:       "",
		},
		{
			...
			command:   []string{"l"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder  Priority\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00            0\n4   scenario test 6                                                               50\n2   scenario test modified 1                            2099/1/1 12:00            100\n3   scenario test 2                                     2099/1/1 00:00  macos     100\n",
			wantError: false,
			err:       "",
		},
		{
