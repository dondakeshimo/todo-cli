...
func TestWithoutReminder(t *testing.T) {
	...
	scenarios := []struct {
	...
	}{
		{
			...
			command:   []string{"l"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00  \n",
			wantError: false,
			err:       "",
		},
		{
		...
		},
		{
			...
			command:   []string{"l"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00  \n2   scenario test 1                                                     \n3   scenario test 2                                     2099/1/1 00:00  macos\n",
			wantError: false,
			err:       "",
		},
		{
		...
		},
		{
			...
			command:   []string{"l"},
			hasOutput: true,
			want:      "ID  Task                                                RemindTime      reminder\n1   deleting or modifying this task is your first TODO  2099/1/1 00:00  \n2   scenario test modified 1                            2099/1/1 12:00  \n3   scenario test 2                                     2099/1/1 00:00  macos\n",
			wantError: false,
			err:       "",
		},
		{
			name:      "clear tasks",
			command:   []string{"c", "-i=1", "-i=3"},
			hasOutput: false,
			want:      "",
			wantError: false,
			err:       "",
